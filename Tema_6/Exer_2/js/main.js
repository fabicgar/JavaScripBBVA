class MainControler {
    ...
    init() {
        ...
        this._gestionUsuarios.init(this._divGestionUsuarios, this._clientUser);
    }
    ...
    pintarEstructura() {
        ...
        this._divGestionUsuarios = document.createElement("div");
        this._divGestionUsuarios.className = "gestion-usuarios";

        this._container.appendChild(this._divGestionUsuarios);
        document.body.appendChild(this._container);
    }
}

class Usuario {
    constructor(id, nombre, username, email, direccion, telefono, website, compania) {
        this._id = id;
        this._nombre = nombre;
